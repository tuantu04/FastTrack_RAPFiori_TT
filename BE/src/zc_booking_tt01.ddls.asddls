...
define root view entity ZC_BOOKING_TT01
  provider contract transactional_query
  as projection on ZI_BOOKING_TT01
{
  key BookingId,
      ...
      @Consumption.valueHelpDefinition: [{ entity: { name: 'ZI_BOOKING_STATUS_VH_TT01',
      ...
      -- the DOMAIN FIXED VALUES of data elements ZE_CONFIRM_TT01 / ZE_PRIORITY_TT01
      ConfirmFlag,
      Priority,
      ...
      /* Associations */
      _bookingItem : redirected to composition child ZC_BKITEM_TT01,
      _customer,
      _status
}
