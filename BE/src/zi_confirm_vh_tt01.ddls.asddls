...
define view entity ZI_CONFIRM_VH_TT01
  as select from    DDCDS_CUSTOMER_DOMAIN_VALUE(
                      p_domain_name : 'ZD_CONFIRM_TT01' ) as Values
    left outer join DDCDS_CUSTOMER_DOMAIN_VALUE_T(
                      p_domain_name : 'ZD_CONFIRM_TT01' ) as Texts on  Texts.domain_name    = Values.domain_name
